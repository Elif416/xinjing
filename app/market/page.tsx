      ...
      <div className="page-bg activation-bg min-h-screen">
        ...
        <main className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-6 pb-24 pt-12 sm:pt-16">
          <section className="grid gap-6 lg:grid-cols-[minmax(0,1.15fr)_minmax(280px,0.85fr)]">
            <GlassCard className="gap-6 border-white/55 p-8">
              <div>
                <p className="text-xs uppercase tracking-[0.28em] text-slate-400">HeartMirror Goods</p>
            ...
            <GlassCard className="gap-5 border-white/55 p-6">
              <div>
                ...
                <h2 className="mt-3 text-2xl font-semibold tracking-tight text-ink">下单前建议这样做</h2>
              </div>
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div
                    key={item}
                    className="rounded-[24px] border border-white/60 bg-white/72 px-4 py-4 text-sm leading-6 text-slate-600 shadow-sm"
                  >
                    <span className="mr-3 inline-flex h-7 w-7 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-indigo-500 text-xs font-semibold text-white shadow-[0_10px_24px_rgba(59,130,246,0.24)]">
                      {index + 1}
                    </span>
                    {item}
                  </div>
          ...
          <section className="space-y-5">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
              <div>
                ...
                <h2 className="mt-2 text-3xl font-semibold tracking-tight text-ink">可定制品类</h2>
              </div>
